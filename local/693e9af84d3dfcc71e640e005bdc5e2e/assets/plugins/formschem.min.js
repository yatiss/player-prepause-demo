var global = window.global = window.global || window;
// 一些常用方法
global.trace = console.log.bind(console);
global.each = function (arr, func, $this) {
  var i, len = arr.length;
  for (i = 0; i < len; i++) {
    var re = null;
    if ($this) {
      re = func.call($this, i, arr[i]);
    } else {
      re = func.call(arr[i], i, arr[i]);
    }
    if (re == false) {
      break;
    }
...
!function(){function e(e){return e instanceof HTMLElement||e instanceof SVGElement}function t(t){if(!e(t))throw new Error("an HTMLElement or SVGElement is required; got "+t)}function n(e){return e&&0==e.lastIndexOf("http",0)&&e.lastIndexOf(window.location.host)==-1}function r(e,r){t(e);var o=e.querySelectorAll("image"),i=o.length,a=function(){0===i&&r()};a();for(var s=0;s<o.length;s++)!function(e){var t=e.getAttributeNS("http://www.w3.org/1999/xlink","href");if(t&&n(t.value))return void console.warn("Cannot render embedded images linking to external hosts: "+t.value);var r=document.createElement("canvas"),o=r.getContext("2d"),s=new Image;t=t||e.getAttribute("href"),t?(s.src=t,s.onload=function(){r.width=s.width,r.height=s.height,o.drawImage(s,0,0),e.setAttributeNS("http://www.w3.org/1999/xlink","href",r.toDataURL("image/png")),i--,a()},s.onerror=function(){console.log("Could not load "+t),i--,a()}):(i--,a())}(o[s])}function o(e,t){for(var n="",r=document.styleSheets,o=0;o<r.length;o++){try{var i=r[o].cssRules}catch(e){console.warn("Stylesheet could not be loaded: "+r[o].href);continue}if(null!=i)for(var a=0;a<i.length;a++){var s=i[a];if("undefined"!=typeof s.style){var l,c;try{c=s.selectorText}catch(e){console.warn('The following CSS rule has an invalid selector: "'+s+'"',e)}try{c&&(l=e.querySelector(c))}catch(e){console.warn('Invalid CSS selector "'+c+'"',e)}if(l){var d=t?t(s.selectorText):s.selectorText;n+=d+" { "+s.style.cssText+" }\n"}else s.cssText.match(/^@font-face/)&&(n+=s.cssText+"\n")}}}return n}function i(e,t,n){var r=e.viewBox&&e.viewBox.baseVal&&e.viewBox.baseVal[n]||null!==t.getAttribute(n)&&!t.getAttribute(n).match(/%$/)&&parseInt(t.getAttribute(n))||e.getBoundingClientRect()[n]||parseInt(t.style[n])||parseInt(window.getComputedStyle(e).getPropertyValue(n));return"undefined"==typeof r||null===r||isNaN(parseFloat(r))?0:r}function a(e){return e=encodeURIComponent(e),e=e.replace(/%([0-9A-F]{2})/g,function(e,t){var n=String.fromCharCode("0x"+t);return"%"===n?"%25":n}),decodeURIComponent(e)}function s(e,t){var n=document.createElement("a");n.download=e,n.href=t,document.body.appendChild(n),n.addEventListener("click",function(e){n.parentNode.removeChild(n)}),n.click()}var l="undefined"!=typeof exports&&exports||"undefined"!=typeof define&&{}||this,c='<?xml version="1.0" standalone="no"?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd" [<!ENTITY nbsp "&#160;">]>';l.svgAsDataUri=function(e,n,s){t(e),n=n||{},n.scale=n.scale||1,n.responsive=n.responsive||!1;var l="http://www.w3.org/2000/xmlns/";r(e,function(){var t,r,d=document.createElement("div"),u=e.cloneNode(!0);if("svg"==e.tagName)t=n.width||i(e,u,"width"),r=n.height||i(e,u,"height");else{if(!e.getBBox)return void console.error("Attempted to render non-SVG element",e);var f=e.getBBox();t=f.x+f.width,r=f.y+f.height,u.setAttribute("transform",u.getAttribute("transform").replace(/translate\(.*?\)/,""));var g=document.createElementNS("http://www.w3.org/2000/svg","svg");g.appendChild(u),u=g}u.setAttribute("version","1.1"),u.getAttribute("xmlns")||u.setAttributeNS(l,"xmlns","http://www.w3.org/2000/svg"),u.getAttribute("xmlns:xlink")||u.setAttributeNS(l,"xmlns:xlink","http://www.w3.org/1999/xlink"),n.responsive?(u.removeAttribute("width"),u.removeAttribute("height"),u.setAttribute("preserveAspectRatio","xMinYMin meet")):(u.setAttribute("width",t*n.scale),u.setAttribute("height",r*n.scale)),u.setAttribute("viewBox",[n.left||0,n.top||0,t,r].join(" "));for(var h=u.querySelectorAll("foreignObject > *"),w=0;w<h.length;w++)h[w].getAttributeNS("xml","xmlns")||h[w].setAttributeNS(l,"xmlns","http://www.w3.org/1999/xhtml");d.appendChild(u);var v=o(e,n.selectorRemap),m=document.createElement("style");m.setAttribute("type","text/css"),m.innerHTML="<![CDATA[\n"+v+"\n]]>";var p=document.createElement("defs");p.appendChild(m),u.insertBefore(p,u.firstChild);var g=c+d.innerHTML,x="data:image/svg+xml;base64,"+window.btoa(a(g));s&&s(x)})},l.svgAsPngUri=function(e,t,n){function r(){var e=o[c],t=i[c];l.svgAsDataUri(e,t,function(e){var o=new Image;o.onload=function(){0==c&&(a.width=o.width,a.height=o.height);var e=t&&t.offsetX?t.offsetX:0,i=t&&t.offsetY?t.offsetY:0;if(s.drawImage(o,e,i),c++,c==d){var l;document.createElement("a");try{l=a.toDataURL("image/png")}catch(e){if("undefined"!=typeof SecurityError&&e instanceof SecurityError||"SecurityError"==e.name)return void console.error("Rendered SVG images cannot be downloaded in this browser.");throw e}n(l)}else r()},o.onerror=function(){console.error("There was an error loading the data URI as an image on the following SVG\n",window.atob(e.slice(26)),"\n","Open the following link to see browser's diagnosis\n",e)},o.src=e})}var o=[],i=[];e instanceof Array?(o=e,i=t):(o=[e],i=[t]);var a=document.createElement("canvas"),s=a.getContext("2d");i[0]&&i[0].backgroundColor&&(s.fillStyle=i[0].backgroundColor,s.fillRect(0,0,a.width,a.height));var c=0,d=o.length;r()},l.saveSvg=function(e,n,r){t(e),r=r||{},l.svgAsDataUri(e,r,function(e){s(n,e)})},l.saveSvgAsPng=function(e,t,n){n=n||{},l.svgAsPngUri(e,n,function(e){s(t,e)})},"undefined"!=typeof define&&define(function(){return l})}();
